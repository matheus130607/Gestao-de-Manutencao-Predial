...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div class="flex h-screen w-full overflow-hidden" style="background:#05050A;">

        {{-- LADO ESQUERDO: canvas animado --}}
        <div
            id="login-canvas-pane"
            class="relative hidden lg:flex lg:w-9/10 items-stretch overflow-hidden"
        >
            <canvas id="tech-canvas" class="absolute inset-0 block" style="width:100%;height:100%;pointer-events:none;"></canvas>

            <div class="relative z-10 flex w-full flex-col items-center justify-between py-16 px-12 text-white pointer-events-none select-none">
                <div class="flex items-center gap-3">
                    <div class="flex h-10 w-10 items-center justify-center rounded-xl border border-red-600/50 bg-red-600/10">
                    ...
                    <span class="text-sm font-semibold tracking-wide text-gray-300">GMP Sistema</span>
                </div>

                <div class="text-center">
                    <div class="mx-auto mb-5 h-0.5 w-10 bg-red-600"></div>
                    <h1 class="mb-3 text-3xl font-bold leading-tight tracking-tight xl:text-4xl">
                        Gestão de Manutenção<br />Predial
                    </h1>
                    <p class="text-sm leading-relaxed text-gray-400 xl:text-base">
        ...
        <div class="flex w-full items-center justify-center bg-white px-6 py-12 lg:w-1/10">
